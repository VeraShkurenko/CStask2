...
public:
	...
	void SendDataMessage(const char * str);//метод для отправки сообщения пользователя
	void SendDataMessage(string str);//метод для отправки сообщения пользователя
};
